...
<head>
    ...
    <title>Juggernaut - Login Form</title>
...
<div class="container">
    ...
    <form class="form-signin" method="POST" action="{{ route('login') }}">
        {{ csrf_field() }}
        <h2 class="form-signin-heading">Juggernaut </h2>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" name="forgotEmail" placeholder="Recovery Email" autocomplete="off"
