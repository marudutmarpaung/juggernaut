...
<section id="container" >
    ...
    <header class="header white-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo">JUGGER<span>NAUT</span></a>
        <!--logo end-->
                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <a href="#" class="task-thumb">
                                <img src="{{url('admin/img/avatar1.jpg')}}" alt="">
                            </a>
                                    ...
                                    <div class="timeline-desk">
                                        <div class="panel">
                                            <div class="panel-body">
                                                ...
                                                <div class="album">
                                                    <a href="#">
                                                        <img alt="" src="{{url('admin/img/sm-img-1.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{url('admin/img/sm-img-2.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{url('admin/img/sm-img-3.jpg')}}">
                                                    </a>
                                                    <a href="#">
                                                        <img alt="" src="{{url('admin/img/sm-img-1.jpg')}}">
                                                    </a>
                                ...
                                <div class="follower">
                                    <div class="panel-body">
                                        ...
                                        <div class="follow-ava">
                                            <img src="{{url('admin/img/follower-avatar.jpg')}}" alt="">
                                        </div>
                                    </div>
                                </div>
