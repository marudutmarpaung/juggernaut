...
<head>
    ...
    <link rel="shortcut icon" href="invoker.png">

    <title>Juggernaut - @yield('title')</title>
    ...
    <link href="{{url('admin/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css')}}" rel="stylesheet"
...
<section id="container">
    ...
    <header class="header white-bg">
        ...
        <!--logo start-->
        <a href="index.html" class="logo">INVO<span>KER</span></a>
        <!--logo end-->
                ...
                <li id="header_inbox_bar" class="dropdown">
                    ...
                    <ul class="dropdown-menu extended inbox">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar"
                                                         src="{{url('admin/')}}./img/avatar-mini.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar"
                                                         src="{{url('admin/img/avatar-mini2.jpg')}}"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar"
                                                         src="{{url('admin/')}}./img/avatar-mini3.jpg"></span>
                                <span class="subject">
                        ...
                        <li>
                            <a href="#">
                                <span class="photo"><img alt="avatar"
                                                         src="{{url('admin/')}}./img/avatar-mini4.jpg"></span>
                                <span class="subject">
        ...
        <div class="top-nav ">
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="img/user/{{$user->avatar}}">
